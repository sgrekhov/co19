...
import 'diff_uri_lib1.dart';
import 'diff_uri_lib2.dart';

main() {
  Expect.equals(0, lib1Increment);
  Expect.equals(1, lib1Counter);
  Expect.equals(0, lib2Increment);
  Expect.equals(1, lib2Counter);
}
