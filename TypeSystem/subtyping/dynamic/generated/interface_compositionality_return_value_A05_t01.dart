...
C0<U0> returnValueFunc() => forgetType(t0Instance);

class ReturnValueTest {
  static C0<U0> staticTestMethod() => forgetType(t0Instance);

  C0<U0> testMethod() => forgetType(t0Instance);

  C0<U0> get testGetter => forgetType(t0Instance);
}
...
main() {
  C0<U0> returnValueLocalFunc() => forgetType(t0Instance);
  ...
  new ReturnValueGen<C0<U0>>().testMethod();
  new ReturnValueGen<C0<U0>>().testGetter;
}
