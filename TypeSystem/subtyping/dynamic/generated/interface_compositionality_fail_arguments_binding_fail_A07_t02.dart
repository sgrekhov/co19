...
/// and `T1` is `C0<U0, ..., Uk>` and there is `Uj == dynamic`, `Sj != dynamic`
...
///
/// This test is generated from test_types/interface_compositionality_fail_A07.dart and
...
class ArgumentsBindingSuper1_t02 {
  ...
  ArgumentsBindingSuper1_t02(C0<U0, U1> value): m = value {}
  ArgumentsBindingSuper1_t02.named(C0<U0, U1> value, {C0<U0, U1> val2 = t1Default}): m = value {}
  ArgumentsBindingSuper1_t02.positional(C0<U0, U1> value, [C0<U0, U1> val2 = t1Default]): m = value {}
  ArgumentsBindingSuper1_t02.short(this.m);

  void superTest(C0<U0, U1> val) {}
  void superTestPositioned(C0<U0, U1> val, [C0<U0, U1> val2 = t1Default]) {}
  void superTestNamed(C0<U0, U1> val, {C0<U0, U1> val2 = t1Default}) {}
  C0<U0, U1> get superGetter => forgetType(t0Instance);
...
main() {
  ...
  Expect.throws(() {
    new ArgumentsBinding2_t02<C0<U0, U1>>(forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t02<C0<U0, U1>>.c2(t1Instance, forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t02<C0<U0, U1>>.c5(forgetType(t0Instance));
  }, (e) => e is TypeError);

  // test generic class members
  Expect.throws(() {
    new ArgumentsBinding2_t02<C0<U0, U1>>(t1Instance).superTest(forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t02<C0<U0, U1>>(t1Instance).superTestNamed(forgetType(t1Instance), val2: forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t02<C0<U0, U1>>(t1Instance).superSetter = forgetType(t0Instance);
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t02<C0<U0, U1>>(t1Instance).superGetter;
  }, (e) => e is TypeError);

  new ArgumentsBinding2_t02<C0<U0, U1>>(t1Instance).test();
}
