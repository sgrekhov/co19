...
main() {
  ...
  Expect.throws(() {
    new ArgumentsBinding2_t03<C0<U0, U1>>().superTest(forgetType(t0Instance));
  }, (e) => e is TypeError);
  ...
  Expect.throws(() {
    new ArgumentsBinding2_t03<C0<U0, U1>>().superTestNamed(forgetType(t0Instance), val2: forgetType(t1Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t03<C0<U0, U1>>().superTestNamed(forgetType(t1Instance), val2: forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t03<C0<U0, U1>>().superSetter = forgetType(t0Instance);
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t03<C0<U0, U1>>().superGetter;
  }, (e) => e is TypeError);

  new ArgumentsBinding2_t03<C0<U0, U1>>().test();
}
