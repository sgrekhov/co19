...
///   - `Never` otherwise
///
/// @description Check that DOWN(`T1`, `T2`) = NonNull(`T2`) if `T1 != T2`, `T1`
/// and `T2` are neither TOP, BOTTOM, NULL, if OBJECT(`T1`), not OBJECT(`T2`),
/// `T2` is not non-nullable and NonNull(`T2`) is non-nullable.
...
void f5a(void Function(Object) v1, void Function(FutureOr<int>?) v2) {
  // NonNull(FutureOr<int>?) = FutureOr<int>, which is non-nullable
  var v = (1 > 2) ? v1 : v2;
...
void f12a(void Function(Object) v1, void Function(Never?) v2) {
  // DOWN(Object, Never?) = Never because NonNull(Never?) = Never
  var v = (1 > 2) ? v1 : v2;
  v.expectStaticType<Exactly<void Function(Never)>>();
}

void f12b(void Function(FutureOr<Object>) v1, void Function(Never?) v2) {
  var v = (1 > 2) ? v1 : v2;
  v.expectStaticType<Exactly<void Function(Never)>>();
}
