...
/// `T2`) if `T1? != T2?` and the operands are not the same type and none of
/// them is TOP, BOTTOM, NULL, or OBJECT. Test that if `T1` and `T2` are not
/// subtypes of each other then `S` is DOWN(`T1`, `T2`).
